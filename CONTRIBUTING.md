# Contributing to myxios

We would love for you to contribute to myxios and help make it even better than it is today!
...
1. Search [GitHub](https://github.com/S2thend/myxios/pulls) for an open or closed PR that relates to your submission.
...
9. In GitHub, send a pull request to `myxios:main`.
...
[github]: https://github.com/S2thend/myxios
